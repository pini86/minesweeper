...
import type { MenuGroups } from "../../constants/Constants";
import type { MouseEventType } from "../../interfaces/Interfaces";
...
export function MenuItem({
  ...
  return (
    ...
    >
      {children}
      {active ? (
        <div className={styles.menuList}>{renderMenuList(id)}</div>
      ) : null}
    </div>
  );
}
